...
<header>
	<h1>Assignment 2 - Animate a motion path</h1>
</header>
...
<style lang="scss">
	...
	*/
	.animated-item {
		// 1. Add an animation with the name animation-path.

		// 2. Add an animation-timeline.

		// 3. Pick one of the offset-path options
		// offset-path: polygon(0% 20%, 60% 20%, 60% 0%, 100% 50%, 60% 100%, 60% 80%, 0% 80%);
